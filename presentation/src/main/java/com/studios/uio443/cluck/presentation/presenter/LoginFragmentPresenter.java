    ...
    private final class UserProfileObserver extends DefaultObserver<User> {
        ...
        public void onComplete() {
            ...
            if (UserHolder.getInstance().getUser() == null) {
                LoginFragmentPresenter.this.view().showLoginFailed();
                return;
            }

            LoginFragmentPresenter.this.view().showLoginSuccess();
            LoginFragmentPresenter.this.view().progressDialog(); //start MainActivity
        }
